...
=begin
  		def server_keypair
  			raise UninitializedError, "No server keypair." unless @curve[:server_public_key] and @curve[:server_private_key]
  			[ @curve[:server_public_key], @curve[:server_private_key] ]
  		end

  		def client_keypair
  			raise UninitializedError, "No client keypair." unless @curve[:client_public_key] and @curve[:client_private_key]
  			[ @curve[:client_public_key], @curve[:client_private_key] ]
  		end
=end
